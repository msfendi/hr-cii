...
class GeneratePayrollExportAudit implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        */
        ...
        $overtimeAgg = DB::table('overtimes_payroll_audit')
    ...
    ")
        ...
        $data = DB::table('payroll_run_details_audit as prd')
            ->leftJoinSub(
                $employeeUnion,
                'emp',
        ...
        */
        ...
        $folder = "public/payroll_audit/$periodNameFormatted";
