                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header">
                        ...
                        <h6 class="font-weight-bold text-primary">
                            Form Edit Department Break Time
                        </h6>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('dept-breaktime.update',$deptBreak->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="id_dept"
                                    class="form-control"
                                    value="{{ old('id_dept',$deptBreak->id_dept) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_break" class="form-control">
                                    ...
                                    @foreach($breaks as $break)
                                        ...
                                        <option
                                            value="{{ $break->id }}"
                                            {{ old('id_break',$deptBreak->id_break)==$break->id?'selected':'' }}>
