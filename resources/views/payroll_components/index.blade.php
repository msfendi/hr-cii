        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <div>
                    <a href="{{ route('payroll-components.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('payroll-components.edit', ['id' => $component->id]) }}" class="btn btn-primary btn-circle btn-sm">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a class="btn btn-danger btn-circle btn-sm btn-delete-payroll_comp" data-delete-link="{{ route('payroll-components.delete', ['id' => $component->id]) }}" data-payroll_comp-name="{{ $component->name }}" data-toggle="modal" data-target="#deleteModal">
