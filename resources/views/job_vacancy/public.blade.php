...
<head>
    ...
    {{-- CSS inti Quill untuk render rich text --}}
    ...
    <style>
        ...
        .tag-pill.benefit-tag {
            background: #e6f8f1;
            border-color: #b7dfd0;
            color: #159d6f;
        }

        .tag-pill.requirement-tag {
            background: #fef5e0;
            border-color: #f5dba8;
            color: #b8860b;
        }
        ...
        .detail-hero.hero-open {
            background: linear-gradient(135deg, #17b881, #1cc88a);
        }
        .detail-hero.hero-upcoming {
            background: linear-gradient(135deg, #1a8fa3, #36b9cc);
        }
        .detail-hero.hero-expired {
            background: linear-gradient(135deg, #d99a1c, #f6c23e);
        }
        .detail-hero.hero-closed {
            background: linear-gradient(135deg, #6b6d7d, #858796);
        }
        .detail-hero.hero-draft {
            background: linear-gradient(135deg, #9195c9, #b7bade);
        }
        ...
        .detail-section.benefit-card {
            background: #f0fdf4;
            border-left: 4px solid #22c55e;
        }

        .detail-section.requirement-card {
            background: #fefce8;
        ...
        .section-label.benefit-label {
            color: #16a34a;
        }

        .section-label.requirement-label {
            color: #ca8a04;
        }
        ...
        .detail-checklist li.benefit-item i {
            color: #22c55e;
        }

        .detail-checklist li.requirement-item i {
            color: #eab308;
        }
        ...
        /* ===== BENEFIT & PERSYARATAN CARD KECIL DI MODAL PERINGATAN ===== */
        .mini-benefit-section {
            margin-top: 1.25rem;
            margin-bottom: 1rem;
        }

        .mini-benefit-section .mini-card-title {
            font-weight: 700;
            font-size: .82rem;
            color: #2e2f45;
            margin-bottom: .6rem;
        ...
        .mini-benefit-section .mini-card-title i {
            font-size: .9rem;
        }

        .mini-benefit-section .mini-card-title .title-icon-benefit {
            color: #22c55e;
        }

        .mini-benefit-section .mini-card-title .title-icon-requirement {
            color: #eab308;
        }
        ...
        .mini-benefit-grid .mini-pill i {
            font-size: .65rem;
        }

        .mini-benefit-grid .mini-pill.benefit-pill {
            background: #ecfdf5;
            border-color: #bbf7d0;
            color: #065f46;
        }

        .mini-benefit-grid .mini-pill.benefit-pill i {
            color: #22c55e;
        }

        .mini-benefit-grid .mini-pill.requirement-pill {
            background: #fefce8;
            border-color: #fde68a;
            color: #854d0e;
        }

        .mini-benefit-grid .mini-pill.requirement-pill i {
            color: #eab308;
        }
        ...
        .mini-benefit-col.benefit-col {
            background: #f0fdf4;
            border-color: #bbf7d0;
        }

        .mini-benefit-col.requirement-col {
            background: #fefce8;
            border-color: #fde68a;
        }
...
<body>
    ...
    {{-- ===== MODAL PERINGATAN PENIPUAN (dengan benefit & persyaratan) ===== --}}
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    {{-- ===== BENEFIT & PERSYARATAN CARD KECIL (seperti gambar) ===== --}}
                    <div class="mini-benefit-section">
                        <div class="row">
                            {{-- Kolom Benefit --}}
                            <div class="col-md-6 mb-3 mb-md-0">
                                <div class="mini-benefit-col benefit-col">
                                    <div class="mini-card-title">
                                        <i class="fas fa-gift title-icon-benefit"></i>
                                        BENEFIT
                                    </div>
                                    <div class="mini-benefit-grid">
                                        <span class="mini-pill benefit-pill"><i class="fas fa-check-circle"></i> Gaji diatas UMR ONTIME</span>
                                        <span class="mini-pill benefit-pill"><i class="fas fa-check-circle"></i> Premi Kehadiran</span>
                                        <span class="mini-pill benefit-pill"><i class="fas fa-check-circle"></i> Insentif Produksi</span>
                                        <span class="mini-pill benefit-pill"><i class="fas fa-check-circle"></i> Makan Siang Gratis</span>
                                        <span class="mini-pill benefit-pill"><i class="fas fa-check-circle"></i> BPJS Kesehatan &amp; Ketenagakerjaan</span>
                                        <span class="mini-pill benefit-pill"><i class="fas fa-check-circle"></i> THR</span>
                                        <span class="mini-pill benefit-pill"><i class="fas fa-check-circle"></i> Seragam</span>
                                        <span class="mini-pill benefit-pill"><i class="fas fa-check-circle"></i> Pelatihan</span>
                                        <span class="mini-pill benefit-pill"><i class="fas fa-check-circle"></i> Uang Lembur Sesuai Peraturan</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            {{-- Kolom Persyaratan --}}
                            <div class="col-md-6">
                                <div class="mini-benefit-col requirement-col">
                                    <div class="mini-card-title">
                                        <i class="fas fa-list-check title-icon-requirement"></i>
                                        PERSYARATAN
                                    </div>
                                    <div class="mini-benefit-grid">
                                        <span class="mini-pill requirement-pill"><i class="fas fa-circle"></i> Usia minimal 18 tahun</span>
                                        <span class="mini-pill requirement-pill"><i class="fas fa-circle"></i> Pengalaman diutamakan</span>
                                        <span class="mini-pill requirement-pill"><i class="fas fa-circle"></i> Sehat jasmani dan rohani</span>
                                        <span class="mini-pill requirement-pill"><i class="fas fa-circle"></i> Siap bekerja dan belajar bersama tim</span>
                                        <span class="mini-pill requirement-pill"><i class="fas fa-circle"></i> Bersedia bekerja di Sukoharjo</span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        // ===== DEFAULT BENEFIT & PERSYARATAN (sesuai gambar) =====
        const defaultBenefits = [
            'Gaji diatas UMR ONTIME',
            'Premi Kehadiran',
            'Insentif Produksi',
            'Makan Siang Gratis',
        ...
        const defaultRequirements = [
            ...
            'Siap bekerja dan belajar bersama tim',
            'Bersedia bekerja di Sukoharjo'
        ];
        ...
        function renderVacancyCard(v) {
            ...
            const benefits = v.benefits || defaultBenefits;
            const benefitTags = benefits.slice(0, 4)
                .map(b => `<span class="tag-pill benefit-tag"><i class="fas fa-check-circle mr-1"></i>${escapeHtml(b)}</span>`)
                .join('');
            const moreBenefits = benefits.length > 4 ?
                `<span class="tag-pill benefit-tag">+${benefits.length - 4} lainnya</span>` :
                '';

            const requirements = v.requirements || defaultRequirements;
            const reqTags = requirements.slice(0, 4)
                .map(r => `<span class="tag-pill requirement-tag"><i class="fas fa-circle mr-1"></i>${escapeHtml(r)}</span>`)
                .join('');
            const moreReqs = requirements.length > 4 ?
                `<span class="tag-pill requirement-tag">+${requirements.length - 4} lainnya</span>` :
                '';
            ...
            <div class="col-xl-4 col-md-6 mb-4" data-id="${v.id}">
                <div class="card vacancy-card shadow h-100">
                    ...
                    <div class="card-body">
                        ...
                        ${benefitTags ? `<div class="mt-2"><div class="vacancy-meta font-weight-bold mb-1"><i class="fas fa-gift text-success mr-1"></i>Benefit</div>${benefitTags}${moreBenefits}</div>` : ''}
                        ${reqTags ? `<div class="mt-2"><div class="vacancy-meta font-weight-bold mb-1"><i class="fas fa-list-check text-warning mr-1"></i>Persyaratan</div>${reqTags}${moreReqs}</div>` : ''}
                    </div>
        ...
        function showDetail(v) {
            ...
            const criteriaList = (v.criteria || []).length ?
                '<ul class="detail-checklist">' + v.criteria.map(c =>
                    `<li><i class="fas fa-check-circle text-success"></i><span>${escapeHtml(c)}</span></li>`).join('') +
                '</ul>' :
                '<p class="detail-empty-note">Tidak ada kriteria khusus.</p>';

            const docList = (v.required_documents || []).length ?
                '<ul class="detail-checklist">' + v.required_documents.map(d =>
                    `<li><i class="fas fa-paperclip text-primary"></i><span>${escapeHtml(d)}</span></li>`).join('') +
                '</ul>' :
                '<p class="detail-empty-note">Tidak ada dokumen khusus.</p>';

            const benefitList = benefits.length ?
                '<ul class="detail-checklist">' + benefits.map(b =>
                    `<li class="benefit-item"><i class="fas fa-gift"></i><span>${escapeHtml(b)}</span></li>`).join('') +
                '</ul>' :
                '<p class="detail-empty-note">Tidak ada benefit yang dicantumkan.</p>';

            const requirementList = requirements.length ?
                '<ul class="detail-checklist">' + requirements.map(r =>
                    `<li class="requirement-item"><i class="fas fa-circle"></i><span>${escapeHtml(r)}</span></li>`).join(
                    '') + '</ul>' :
                '<p class="detail-empty-note">Tidak ada persyaratan yang dicantumkan.</p>';
            ...
            $('#detailBody').html(`
                ...
                <div class="detail-section benefit-card">
                    <div class="section-label benefit-label"><i class="fas fa-gift mr-1"></i>Benefit</div>
                    ${benefitList}
                </div>

                <div class="detail-section requirement-card">
                    <div class="section-label requirement-label"><i class="fas fa-list-check mr-1"></i>Persyaratan</div>
                    ${requirementList}
                </div>
            ...
            fetch(routes.data + '?' + new URLSearchParams(params))
                ...
                .then(data => {
                    ...
                    data.rows = data.rows.map(v => ({
                        ...
                        requirements: v.requirements || defaultRequirements,
                    }));
