        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800">Edit Employee Violation</h1>
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                ...
                @endif
                <form action="{{ route('employee-violation.update', $row->id) }}" method="POST">
                  @csrf
                  @method('PUT')
                  <div class="form-group">
                    ...
                    <select name="period_id" id="period_id" class="form-control">
                      ...
                      <option value="{{ $period->id }}" {{ old('period_id', $row->period_id) == $period->id ? 'selected' : '' }}>
                        {{ $period->name }}
                      </option>
                      @endforeach
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="number" step="0.01" min="0" max="100" name="percentage" id="percentage" class="form-control" value="{{ old('percentage', $row->percentage) }}" placeholder="0.00">
