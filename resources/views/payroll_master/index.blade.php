         ...
         <div id="content">
            ...
            <div class="container-fluid">
               <div class="d-sm-flex align-items-center justify-content-between mb-4">
                  ...
                  <div>
                     <a href="{{ route('payroll-master.create') }}"
                        ...
                        <table class="table table-bordered table-sm"
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>{{ number_format($row->allowance,0,',','.') }}</td>
                                 <td class="text-center">
                                    <a href="{{ route('payroll-master.edit',$row->id) }}"
                                       class="btn btn-primary btn-circle btn-sm">
                                    <i class="fas fa-edit"></i>
                                    </a>
                                    <a class="btn btn-danger btn-circle btn-sm btn-delete-payroll_master"
                                       data-delete-link="{{ route('payroll-master.delete',$row->id) }}"
                                       data-npk="{{ $row->npk }}"
                                       data-toggle="modal"
