                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-sm" id="approvalTable" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th width="40">No</th>
                                        <th>Nama Group</th>
            ...
            <form id="formGroup">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="select2" id="group_dept" name="dept[]" multiple="multiple" required style="width: 100%;">
                            @foreach($depts as $d)
                    ...
                    <form id="formRule">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" id="rule_name" placeholder="Contoh: SPV, Chief" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label>Cari Karyawan (NPK/Nama) <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="rule_search" placeholder="Ketik NPK atau nama..." autocomplete="off">
                                <div id="searchResults" class="list-group position-absolute w-100" style="z-index:1050; max-height:200px; overflow-y:auto; display:none;"></div>
                            </div>
                            <div class="form-group col-md-3">
                                <label>NPK Approver</label>
                                <input type="text" class="form-control" id="rule_approval_id" readonly placeholder="Otomatis terisi">
                            </div>
                        </div>
                        <div class="d-flex justify-content-end" style="gap:.5rem;">
                            <button type="button" class="btn btn-secondary btn-sm" id="btnCancelRule">Batal</button>
...
$(document).ready(function () {
    ...
    /**
     * Render the rules/approver table inside the Rules modal.
     * - rules: Array of rule objects from the server
     */
    ...
    $('#formRule').on('submit', function (e) {
        ...
        // Determine if this is an update or a new rule
    ...
    // When an employee is selected from search results
