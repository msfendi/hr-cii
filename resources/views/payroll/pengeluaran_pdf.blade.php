...
<table class="border">
    ...
    @if(!empty($approvals))
      ...
      @endif
      <!-- {{-- ===================================== --}}
{{-- HALAMAN 3 - KARYAWAN MANGKIR --}}
{{-- ===================================== --}}
@if(collect($mangkirTotals)->sum() > 0)
...
<div>
    @php
        $netto_mangkir = $total_bruto - $total_potongan;

        $netto_str = number_format($netto_mangkir, 4, '.', '');
