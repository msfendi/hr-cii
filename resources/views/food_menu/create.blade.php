<!-- resources/views/food_menu/create.blade.php -->
<!DOCTYPE html>
<html lang="en">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <style>
            ...
            /* Kiosk device frame — the signature element */
          ...
          <div class="fm-kiosk">
            <div class="fm-head">
              ...
              <p>Isi detail menu — preview di samping menunjukkan tampilannya di layar kiosk.</p>
            </div>
            ...
            <form action="{{ route('food-menus.store') }}" method="POST" enctype="multipart/form-data" id="menuForm">
              @csrf
              ...
              <div class="fm-layout">
                ...
                <div class="fm-preview-col">
                  <div class="fm-kiosk-screen">
                    <div class="fm-kiosk-photo" id="previewPhotoWrap">
                      <img id="previewPhoto" src="" style="display:none;" alt="">
                      <div id="previewPhotoPlaceholder" class="fm-photo-placeholder">
                        <i class="fas fa-utensils"></i>
                        <span>Foto Menu</span>
                      </div>
                    </div>
                    <div class="fm-kiosk-info">
                      <span class="fm-kiosk-canteen" id="previewCanteen">Pilih Kantin</span>
                      <h3 id="previewName">Nama Menu</h3>
                      <p id="previewDesc" class="fm-kiosk-desc">Deskripsi menu akan tampil di sini</p>
                      <div class="fm-kiosk-footer">
                        <span class="fm-kiosk-price" id="previewPrice">Rp 0</span>
                        <span class="fm-kiosk-quota" id="previewQuota">Unlimited</span>
                      </div>
                      <span class="fm-kiosk-chip" id="previewStatus"><i class="fas fa-circle"></i> Aktif</span>
                    </div>
                  </div>
                ...
                <div class="fm-form-col">
                  ...
                  <div class="fm-section">
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" name="name" id="inputName" class="form-control" placeholder="cth. Nasi Goreng Spesial" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="fm-label">Deskripsi <span class="fm-opt">(opsional)</span></label>
                      <textarea name="description" id="inputDesc" class="form-control" rows="2" placeholder="Deskripsi singkat menu"></textarea>
                    </div>
                    <div class="form-group mb-0">
                      <label class="fm-label">Foto Menu <span class="fm-opt">(opsional)</span></label>
                      <label class="fm-photo-drop" id="photoDrop" for="inputPhoto">
                        <i class="fas fa-cloud-upload-alt"></i>
                        <span id="photoDropText">Klik untuk unggah foto menu (JPG/PNG, maks 2MB)</span>
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        ...
                        <div class="fm-price-input">
                          ...
                          <input type="number" step="0.01" min="0" name="price" id="inputPrice" class="form-control" placeholder="0">
                        </div>
                      </div>
                      <div class="form-group col-md-6">
                        <label class="fm-label">Kuota per Hari <span class="fm-opt">(kosongkan = unlimited)</span></label>
                        <input type="number" min="1" name="quota" id="inputQuota" class="form-control" placeholder="Unlimited">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="fm-section">
                    ...
                    <div class="fm-toggle-row">
                      <div>
                        ...
                        <div class="fm-toggle-sub" id="toggleSub">Menu akan langsung tampil di kiosk</div>
                      </div>
                  ...
                  <div class="fm-actions">
                    <button type="submit" class="fm-btn-primary"><i class="fas fa-save"></i> Simpan Menu</button>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      activeInput.addEventListener('change', function () {
        if (this.checked) {
          ...
          toggleSub.textContent = 'Menu akan langsung tampil di kiosk';
        } else {
      ...
      photoInput.addEventListener('change', function () {
        ...
        document.getElementById('photoDropText').textContent = file ? file.name : 'Klik untuk unggah foto menu (JPG/PNG, maks 2MB)';
        if (file) {
