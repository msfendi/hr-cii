<!-- resources/views/food-order/canteens/create.blade.php -->
<!DOCTYPE html>
<html lang="en">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tambah Kantin</h1>
            ...
            <div class="card-body">
              ...
              <form action="{{ route('canteens.store') }}" method="POST">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    <label>Lokasi</label>
                    <input type="text" name="location" class="form-control" value="{{ old('location') }}" placeholder="Contoh: Gedung A Lantai 1">
                  </div>
                </div>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" name="pic_phone" class="form-control" value="{{ old('pic_phone') }}">
                  </div>
                </div>
