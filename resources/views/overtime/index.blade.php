    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                        ...
                        <div class="card-header py-3 d-sm-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <div class="d-flex align-items-center flex-wrap">
                                    <button type="button" class="btn btn-primary btn-sm mb-2 mr-2" data-toggle="modal"
                                    ...
                                    <form id="actionForm" method="GET" class="form-inline mr-2 mb-2">
                                        ...
                                        {{-- <button type="submit" formaction="{{ route('overtime.downloadTemplate') }}"
                                            class="btn btn-success btn-sm mr-2"
                                            title="Template berdasarkan tanggal hari (untuk insert harian)">
                                            <i class="fas fa-file-excel"></i> Template (Harian)
                                        </button> --}}

                                        <button type="submit" formaction="{{ route('overtime.export-template') }}"
                                            class="btn btn-success btn-sm mr-2"
                                            title="Template berdasarkan bulan kalender (1 - 31)">
                                            <i class="fas fa-file-excel"></i> Template (Kalender)
                                        </button>

                                        <button type="submit" formaction="{{ route('overtime.export') }}"
                                            class="btn btn-info btn-sm">
                                            <i class="fas fa-file-excel"></i> Export Calendar
                                        </button>
                                    </form>

                                    {{-- <button type="button" class="btn btn-danger btn-sm mb-2 mr-2"
                                        id="btnDeleteAll">
            ...
            <div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="importModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form id="importForm" action="{{ route('overtime.import') }}" method="POST"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="file" id="file" accept=".xlsx"
                                        required style="padding-bottom: 2rem;">
                                </div>
                            </div>
            ...
            <div class="modal fade" id="editOvertimeModal" tabindex="-1" role="dialog"
                aria-labelledby="editOvertimeModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <form id="editForm">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.5" class="form-control" id="edit_jam"
