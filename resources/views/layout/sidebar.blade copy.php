...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    @if($roleusers[0]->rolename == 'Admin' || $roleusers[0]->rolename == 'HRD')
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseExpat" aria-expanded="true"
                aria-controls="collapseExpat">
                <i class="fas fa-fw fa-users"></i>
                <span>Expat</span>
            </a>
            <div id="collapseExpat" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{ route('expat.master.index') }}">Expat Master</a>
                    <a class="collapse-item" href="{{ route('expat.onleave.index') }}">On Leave Data</a>
                    <a class="collapse-item" href="{{ route('expat.cost.index') }}">Expat Cost</a>
                </div>
            </div>
        </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapsePayroll" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('payroll-setting.index') }}">Payroll Setting</a>
