              ...
              <div class="card-header py-3">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <form id="importForm" action="{{ route('holidays.import') }}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="input-group input-group-sm">
                        ...
                        <span id="fileName" class="form-control form-control-sm text-truncate" style="max-width:200px">
                          No file selected
                        </span>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <a href="{{ route('holidays.edit',$row->id) }}" class="btn btn-primary btn-circle btn-sm">
                            <i class="fas fa-edit"></i>
                          </a>
                          <a class="btn btn-danger btn-circle btn-sm btn-delete-holiday" data-delete-link="{{ route('holidays.delete',$row->id) }}" data-name="{{ $row->name }}" data-toggle="modal" data-target="#deleteModal">
